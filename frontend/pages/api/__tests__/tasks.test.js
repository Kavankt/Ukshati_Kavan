...
import handler from '../fetch.js'; // Using explicit .js extension
import db from '../../../lib/db.js'; // Using explicit .js extension
...
describe('/api/fetch', () => {
  ...
  beforeEach(() => {
    ...
    db.connectToDB.mockResolvedValue(mockConnection);
